...
public class Scan extends SequentialCommandGroup {
    ...
    public Scan(Hardware _hardware)
    {
        super(
                ...
                new InstantCommand(()->{_hardware.differentialIntake.setPosition(DifferentialIntake.LINEAR_ANGLE_SCAN, intakepos);}),
                ...
                new WaitCommand(50),
                new InstantCommand(()->{_hardware.differentialIntake.SetState(DifferentialIntake.IntakeDifferentialStates.SCAN);
